    ...
    public class TrackingEventReceiverService : Service
    {
        ...
        public override void OnCreate()
        {
            ...
            runnable = () =>
            {
                ...
                {
                    var msg = timestamper.GetFormattedTimestamp();
                    Log.Debug(TAG, msg);
                    var i = new Intent(Constants.NOTIFICATION_BROADCAST_ACTION);
        ...
        private void RegisterForegroundService()
        {
            ...
            var notificationManager =
                (NotificationManager)GetSystemService(NotificationManager.FromContext(this).Class);
        ...
        private Notification.Action BuildRestartTimerAction()
        {
            ...
            var builder = new Notification.Action.Builder(Resource.Drawable.ic_map_pointer,
                "Restart timer",
